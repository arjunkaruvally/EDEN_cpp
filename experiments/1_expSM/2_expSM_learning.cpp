...
//    }
    ...
    std::vector<int> outputs = model.evaluate_learning(max_seq_length, diagnostic_timescale,
                                                       swindow, steps_per_memory, VERBOSE);
    ...
    std::cout<<"Learning result size: "<<outputs.size()<<std::endl;
