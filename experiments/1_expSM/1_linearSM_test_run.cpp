...
int main(int argc, char *argv[]) {
    ...
    program.add_argument("--path")
            .default_value(std::string{"tmp/LinearSM"})   // might otherwise be type const char* leading to an error when trying program.get<std::string>
